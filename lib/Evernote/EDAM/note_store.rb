    ...
    module NoteStore
      module NoteStore
        class Client
          ...
          def shareNotebook(authenticationToken, sharedNotebook, message)
            send_shareNotebook(authenticationToken, sharedNotebook, message)
            return recv_shareNotebook()
          end

          def send_shareNotebook(authenticationToken, sharedNotebook, message)
            send_message('shareNotebook', ShareNotebook_args, :authenticationToken => authenticationToken, :sharedNotebook => sharedNotebook, :message => message)
          end

          def recv_shareNotebook()
            result = receive_message(ShareNotebook_result)
            return result.success unless result.success.nil?
            raise result.userException unless result.userException.nil?
            raise result.notFoundException unless result.notFoundException.nil?
            raise result.systemException unless result.systemException.nil?
            raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'shareNotebook failed: unknown result')
          end
        ...
        class Processor
          ...
          def process_shareNotebook(seqid, iprot, oprot)
            args = read_args(iprot, ShareNotebook_args)
            result = ShareNotebook_result.new()
            begin
              result.success = @handler.shareNotebook(args.authenticationToken, args.sharedNotebook, args.message)
            rescue ::Evernote::EDAM::Error::EDAMUserException => userException
              result.userException = userException
            rescue ::Evernote::EDAM::Error::EDAMNotFoundException => notFoundException
              result.notFoundException = notFoundException
            ...
            write_result(result, oprot, 'shareNotebook', seqid)
          end
