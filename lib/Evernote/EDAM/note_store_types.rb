...
# </dl>
      class NoteResultSpec
        ...
        INCLUDENOTEAPPDATAVALUES = 6
        INCLUDERESOURCEAPPDATAVALUES = 7
        INCLUDEACCOUNTLIMITS = 8
        ...
        FIELDS = {
          ...
          INCLUDESHAREDNOTES => {:type => ::Thrift::Types::BOOL, :name => 'includeSharedNotes', :optional => true},
          INCLUDENOTEAPPDATAVALUES => {:type => ::Thrift::Types::BOOL, :name => 'includeNoteAppDataValues', :optional => true},
          INCLUDERESOURCEAPPDATAVALUES => {:type => ::Thrift::Types::BOOL, :name => 'includeResourceAppDataValues', :optional => true},
          INCLUDEACCOUNTLIMITS => {:type => ::Thrift::Types::BOOL, :name => 'includeAccountLimits', :optional => true}
        }
