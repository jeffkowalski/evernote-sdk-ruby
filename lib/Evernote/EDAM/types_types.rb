  ...
  module EDAM
    module Type
      ...
      module SharedNotebookInstanceRestrictions
        ...
        VALUE_MAP = {1 => "ASSIGNED", 2 => "NO_SHARED_NOTEBOOKS"}
        VALID_VALUES = Set.new([ASSIGNED, NO_SHARED_NOTEBOOKS]).freeze
      end
...
#    </dl>
      class UserAttributes
        ...
        PASSWORDUPDATED = 36
        SALESFORCEPUSHENABLED = 37
        SHOULDLOGCLIENTEVENT = 38
        ...
        FIELDS = {
          ...
          SALESFORCEPUSHENABLED => {:type => ::Thrift::Types::BOOL, :name => 'salesforcePushEnabled', :optional => true},
          SHOULDLOGCLIENTEVENT => {:type => ::Thrift::Types::BOOL, :name => 'shouldLogClientEvent', :optional => true}
        }
...
# </dl>
      class Note
        ...
        FIELDS = {
          ...
          LIMITS => {:type => ::Thrift::Types::STRUCT, :name => 'limits', :class => ::Evernote::EDAM::Type::NoteLimits, :optional => true}
        }
...
# </dl>
      class NotebookRestrictions
        ...
        FIELDS = {
          ...
          NORENAMENOTEBOOK => {:type => ::Thrift::Types::BOOL, :name => 'noRenameNotebook', :optional => true}
        }
